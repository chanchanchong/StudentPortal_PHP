    ...
    <div class="panel-body">
        <?php
            ...
            if(isset ($_POST["update"]))
            {
                ...
                {
                    msgBox("error", "All Field are required");
                }
                else if(!empty ($npass) && ($npass !== $cpass))
                {
                    msgBox("error", "New password must match");
                }
                else
                {
                    //$opass = md5($opass);
        ...
        <form method="post" action="<?php echo $_SERVER["REQUEST_URI"]?>">
            ...
            <div class="form-group">
                ...
                <p class="help-block">To change your password, just fill out below fields with new password</p>
            </div>
            <div class="form-group">
